...
void CANMsgRouter::subscriberTest() {
    ...
    int nodeId5 = RosCanNodeManager::instance().registerNode("arm", 5, 5);
    ...
    roscan::RosCanNodePtr sci_node = RosCanNodeManager::instance().getNode(nodeId5);
    ...
    sci_node->registerSubscriber("/science/servo", "blah");
